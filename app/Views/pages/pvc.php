...
<div class="container-fluid pt-3 custom-margin-skip">
    ...
    <div class="row">
        <div class="container custom-centering-pad">
            <h1 class="display-1 my-5">Finestra in PVC WnD <br> <span class="display-2"> Linea Konfortline </span> </h1>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="container custom-centering-pad prod-profile-img-container py-4">

            <div class="prod-profile-img-text"> 
            ...
            <img src="assets/img/Sezione-Konfortline.jpg" alt="konfortline" class="img-fluid">
        </div>
    ...
    <div class="row custum-row-bg-color my-4 pt-3 pb-4">
